...
void ticket_inquiry();                     //              s
void bill_receipt();                       //              s
void audience();                           //
void currrent_arrangment ();               //
void attendance_checker();                 //              s
void add_movie();                          //              s
void addOns();                                           
void staff();                             
void starting();                          
...
void ticket_inquiry()
{
  ...
  fptr=fopen("home\\Desktop\\taha\\final touches\\Movies.txt","r"); //opening file for reading
...
int count,i;
FILE *fptr;
fptr=fopen("C:\\Users\\shahz\\Desktop\\final touches\\Movies.txt","a");   //first time executed this while on write mode
//fprintf(fptr,"Movie\t\tstart\t\tduration\n");   printed this when i executed it for first time
                                                  //so that we could add headings*/
do{
...
do
{
printf("Press (Y or y) to exit or press (N or n) to enter another id\n");
scanf(" %c",&flag);
}
